...
<head>
    ...
    <title>Tienda Mascotas - Lista Propietarios</title>
...
<body>
    ...
    <section class="jumbotron text-center">
        <div class="container">
        <h1 class="jumbotron-heading">Lista Propietarios</h1>
        </div>
    </section>
    ...
    <div class="container-fluid">
        ...
        <div class="row text-center mt-3">
            <?php
                require_once("../api/lista_propietarios.php")
            ?>                    
        </div>
    </div>
